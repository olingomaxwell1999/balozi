...
import Banner from '../assets/balozifive.jpg'
    ...
    <div className='contact-area'>
      <div className="contact-form-area">
        ...
        <div className="more-text">
            <p style={{fontSize:'20px', color:'#fff'}}>The Balozi Suites does not share or exchange this information with anyone. All information will be kept confidential.</p>
        </div>
      </div>
